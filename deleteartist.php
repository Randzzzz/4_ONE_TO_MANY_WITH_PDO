...
<body>
  ...
  <div class="form">
    <div class="items">
      ...
      <h2>First Name: <?php echo $getArtistByID['first_name']; ?></h2>
      <h2>Last Name: <?php echo $getArtistByID['last_name']; ?></h2>
      <h2>Stage Name: <?php echo $getArtistByID['stage_name']; ?></h2>
      <h2>Gender: <?php echo $getArtistByID['gender']; ?></h2>
      <h2>Email: <?php echo $getArtistByID['email']; ?></h2>
